...
#Trace setup
set fall [open different_delay.tr w]
$ns trace-all $fall

set fnam [open different_delay.nam w]
$ns namtrace-all $fnam

set ftcp [open different_delay.tcp w]
